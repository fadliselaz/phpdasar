...
//ceil disini berfungsi untuk pembulatan nilai float..
...
//LIMIT untuk membatasi berapa data yang akan tampil,
//LIMIT <mulai dari data berapa>, <mau berapa data yang ditampilkan>
$mahasiswa = query("SELECT * FROM mahasiswa ORDER BY id ASC LIMIT 0,$jumlahDataPerhalaman");
// var_dump($mahasiswa);
